...
datasets_path_list =['/data/no12neni/images/image_z_sperated/EGST39_A_Image2_30min',
                     '/data/no12neni/images/image_z_sperated/EGST39_A_Image3_30min']

denoise_model_list =[
    'ATP_2D_best_model_demo',
    'ATP_3D_best_model_demo',
    'NP_2D_best_model_demo',
    'NP_3D_best_model_demo',
    'drosophila_best_model_demo',
    'fish_localbrain_best_model_demo',
    'fish_wholebrain_best_model_demo',
    'mouse_spine_best_model_demo',
    'simulate_-2.51dBSNR_1000frames_best_model_demo'
]

for denoise_model in denoise_model_list :
    for i, datasets_path in enumerate(datasets_path_list) :
        ...
        test_dict = {
            ...
            'pth_dir': '/data/no12neni/pth', # pth file root path
            'denoise_model' : denoise_model,
            'output_dir' : '/data/no12neni/results/EGST39_'+str(i+1),         # result file root path
