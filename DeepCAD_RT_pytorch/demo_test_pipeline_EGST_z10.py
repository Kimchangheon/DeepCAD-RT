...
datasets_path_list =['/data/no12neni/images/image_z_sperated/EGST39_A_Image2_30min_z10',]
denoise_model_list =['EGST39_A_Image2_30min_z10_202407142045']
...
for denoise_model in denoise_model_list :
    for i, datasets_path in enumerate(datasets_path_list) :
        ...
        test_dict = {
            ...
            'output_dir' : '/data/no12neni/results/'+denoise_model,         # result file root path
