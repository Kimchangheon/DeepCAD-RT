...
datasets_path_list =['/data/no12neni/images/image_z_sperated/EGST39_A_Image2_30min_z0',]

denoise_model_list =['EGST39_A_Image2_30min_z0_202406210115'
]
...
for denoise_model in denoise_model_list :
    for i, datasets_path in enumerate(datasets_path_list) :
        ...
        test_dict = {
            ...
            'pth_dir': '/data/no12neni/DeepCAD_RT_pytorch/pth', # pth file root path
            'denoise_model' : denoise_model,
            'output_dir' : '/data/no12neni/results/EGST39_A_Image2_30min_z0_202406210115',         # result file root path
