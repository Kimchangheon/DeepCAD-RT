...
for file_name in file_name_list :
    if download_demo_file:
        ...
        datasets_path, denoise_model =download_demo(download_filename=file_name, dir='/data/no12neni')
    else:
        # datasets_path = '/data/no12neni/datasets/fish_localbrain_demo'  # folder containing tif files for testing
        datasets_path = '/data/no12neni/images'  # folder containing tif files for testing
        denoise_model = 'simulate_-2.51dBSNR_1000frames_best_model_demo'  # A folder containing pth models to be tested
    ...
    test_dict = {
        ...
        'output_dir' : '/data/no12neni/results',         # result file root path
